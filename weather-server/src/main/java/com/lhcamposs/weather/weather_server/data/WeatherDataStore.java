...
public class WeatherDataStore {
    ...
    public WeatherDataStore() {
        dadosCidades.put("Urutai",     Arrays.asList(28.0, 30.0, 25.0, 32.0, 27.0));
        dadosCidades.put("Goiania",    Arrays.asList(33.0, 35.0, 31.0, 34.0, 29.0));
        dadosCidades.put("Brasilia",   Arrays.asList(26.0, 28.0, 24.0, 30.0, 25.0));
        dadosCidades.put("Sao Paulo",  Arrays.asList(22.0, 24.0, 19.0, 25.0, 20.0));
